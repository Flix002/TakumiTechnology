...
export function Page() {
    ...
    return (
        <div className="w-screen bg-[#d3d3d351] h-auto dark:bg-[#121212] relative xl:flex justify-between overflow-hidden xl:pl-[80px]" >
            {/* NavBar */}
            <div className="xl:h-full h-auto fixed left-0 top-0 z-20">
                <Navbar />
                <RpsNavbar />
            </div>
            <div className="w-full h-full xl:px-[50px] ">
